...
void MainWindow::onReadyRead()
{
    ...
    if (lines[0] == "1"){
        ...
        if(lines[25] == "inf"){
            ...
            ui->lidar_8->move(lidar_move(ui->lidar_center->x(), lines[25].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[25].toFloat(), y));
        }
        ...
        if(lines[26] == "inf"){
            ...
            ui->lidar_9->move(lidar_move(ui->lidar_center->x(), lines[26].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[26].toFloat(), y));
        }
        ...
        if(lines[27] == "inf"){
            ...
            ui->lidar_10->move(lidar_move(ui->lidar_center->x(), lines[27].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[27].toFloat(), y));
        }
        ...
        if(lines[28] == "inf"){
            ...
            ui->lidar_11->move(lidar_move(ui->lidar_center->x(), lines[28].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[28].toFloat(), y));
        }
        ...
        if(lines[29] == "inf"){
            ...
            ui->lidar_12->move(lidar_move(ui->lidar_center->x(), lines[29].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[29].toFloat(), y));
        }
        ...
        if(lines[30] == "inf"){
            ...
            ui->lidar_13->move(lidar_move(ui->lidar_center->x(), lines[30].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[30].toFloat(), y));
        }
        ...
        if(lines[31] == "inf"){
            ...
            ui->lidar_14->move(lidar_move(ui->lidar_center->x(), lines[31].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[31].toFloat(), y));
        }
        ...
        if(lines[32] == "inf"){
            ...
            ui->lidar_15->move(lidar_move(ui->lidar_center->x(), lines[32].toFloat(), x), lidar_move(ui->lidar_center->y(), lines[32].toFloat(), y));
        }
