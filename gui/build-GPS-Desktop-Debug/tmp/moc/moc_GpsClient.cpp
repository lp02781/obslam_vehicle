...
QT_MOC_LITERAL(1, 10, 8), // "position"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "GpsClient\0position\0"
};
...
void GpsClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GpsClient *_t = static_cast<GpsClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->position((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (GpsClient::*_t)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GpsClient::position)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GpsClient::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GpsClient.data,
      qt_meta_data_GpsClient,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void GpsClient::position(double _t1, double _t2)
{
