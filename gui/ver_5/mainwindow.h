...
public:
    ...
    //QMovie *audio_movie = new QMovie("/home/mfikih15/Downloads/audio.gif");

    QMovie *ir_movie = new QMovie("../ir.gif");
    QMovie *front_movie = new QMovie("../front.gif");
    QMovie *audio_movie = new QMovie("../audio.gif");
